...
public class Deck : MonoBehaviour
{
    ...
    {
        // Создать точку привязки для всех объектов Card
        ...
        // Инициализировать словать со спрайтами значков всех мастей
    ...
    {
        foreach(Sprite item in faceSprites)
        {
            if (item.name == faceS)
            {
    ...
    {
        List<Card> tCards = new List<Card>(); // Временный список для хранения
        int ndx;
